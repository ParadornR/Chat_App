...
class ChatService extends ChangeNotifier {
  // getinstance of auth and firestore
  ...
  Future<void> sendMessage(String receiverId, String message) async {
    ...
    // consturct chat room id from current user id and receiver id
    List<String> ids = [currentUserId, receiverId];
    ids.sort(); // sort the ids (this ensures the chat room id is always the same for any pair of prople)
    String chatRoomId =
